...
export default {
    ...
    init: function (obj, partial) {
        ...
        var _pageloader_anim_delay = rebus.navigation.isReturningFromBookmark() ? 500 : 150; //time for preloader to play out
